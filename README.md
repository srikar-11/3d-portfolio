...
This repository contains the source code for Motupally Srikar's personal 3D
portfolio, built with React, TypeScript, Three.js, React Three Fiber, and GSAP.
It includes animated page sections, a character scene, custom cursor
interactions, and smooth transitions designed for a modern portfolio
experience.

Based on the open-source [3d-portfolio](https://github.com/akashrmalhotra/3d-portfolio)
template by Akash Malhotra.
